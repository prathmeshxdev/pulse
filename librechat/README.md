...
concurrency on Android in the last hour?"* and the agent queries ClickHouse
through the official [ClickHouse MCP server](https://github.com/ClickHouse/mcp-clickhouse).
...
an Agent with the `clickhouse` MCP tool, paste [`system_prompt.md`](system_prompt.md).
